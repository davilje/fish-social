...
| 文档 | 状态 | 说明 |
|------|------|------|
| [钓鱼玩法扩展-v0.7-Epic.md](./specs/钓鱼玩法扩展-v0.7-Epic.md) | **已确认** | **v0.7 入口**：R1 已交付；R2 回鱼/打窝/相册 |
...
| [回鱼机制.md](./specs/回鱼机制.md) | **已确认** | FEAT-RETURN-01：回塘增重、准入、金≈卖价×0.7 |
| [打窝机制.md](./specs/打窝机制.md) | **已确认** | FEAT-GROUND-01：Overlay 并列循环、50 层非线性、增鱼尺寸 |
| [钓鱼相册与成就.md](./specs/钓鱼相册与成就.md) | **已确认** | FEAT-ALBUM-01：个人中心大改、相册墙、成就 |

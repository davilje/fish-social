...
| 文档 | 状态 | 说明 |
|------|------|------|
| [钓鱼玩法扩展-v0.7-Epic.md](./specs/钓鱼玩法扩展-v0.7-Epic.md) | **已确认** | **v0.7 当前入口**：R1 拆票索引（PROG/GEAR/08A2/RISK/SPOT） |
| [鱼塘分级与玩家成长.md](./specs/鱼塘分级与玩家成长.md) | **已确认** | FEAT-PROG-01：七类塘、双熟练度、每2h扣费、新手、卖价、数值表 |
| [钓具与鱼饵配置.md](./specs/钓具与鱼饵配置.md) | **已确认** | FEAT-GEAR-01：竿弱加成与断竿买新、饵按次扣金、船仅商店 |
| [Steam桌面端-08A2世界地图分区与进塘扣费.md](./specs/Steam桌面端-08A2世界地图分区与进塘扣费.md) | **已确认** | STEAM-DESKTOP-08A2：六区锁态、巨物暂闭、进塘扣费确认 |
| [禁止钓鱼塘巡警事件.md](./specs/禁止钓鱼塘巡警事件.md) | **已确认** | FEAT-RISK-01：巡警气泡 10s、免罚短禁/超时罚款日禁 |

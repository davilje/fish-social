...
| [steam-desktop-07a-pet-home-dev.prompt.md](./steam-desktop-07a-pet-home-dev.prompt.md) | STEAM-DESKTOP-07A：480×320 登录、1280×720 主窗口、底部导航与鱼塘入口（禁止第二 Unity Player）· **已实现** |
| [steam-desktop-07b-pond-scene-dev.prompt.md](./steam-desktop-07b-pond-scene-dev.prompt.md) | STEAM-DESKTOP-07B：960×480 Overlay 鱼塘环境与自己的猫咪 · **已实现** |
| [steam-desktop-07c-multiplayer-pets-dev.prompt.md](./steam-desktop-07c-multiplayer-pets-dev.prompt.md) | STEAM-DESKTOP-07C：Overlay 同塘玩家宠物与状态同步 · **已确认** |
| [steam-desktop-07d-context-menu-dev.prompt.md](./steam-desktop-07d-context-menu-dev.prompt.md) | STEAM-DESKTOP-07D：Overlay/主窗口右键菜单与打开主窗口 · **已确认** |
| [steam-desktop-07e-modal-layer-dev.prompt.md](./steam-desktop-07e-modal-layer-dev.prompt.md) | STEAM-DESKTOP-07E：主窗口底部入口与桌面宠物功能弹窗层 · **已确认** |
| [steam-desktop-07f-main-flow-qa-dev.prompt.md](./steam-desktop-07f-main-flow-qa-dev.prompt.md) | STEAM-DESKTOP-07F：正式窗口、Overlay 与桌面宠物主流程验收 · **已确认** |
| [steam-desktop-07g-native-overlay-dev.prompt.md](./steam-desktop-07g-native-overlay-dev.prompt.md) | STEAM-DESKTOP-07G：960×480 原生鱼塘 Overlay（WPF/Win32 + Named Pipe）· **已实现** |
| [steam-desktop-07g-overlay-lifecycle-fix-dev.prompt.md](./steam-desktop-07g-overlay-lifecycle-fix-dev.prompt.md) | STEAM-DESKTOP-07G：Overlay 启停、隐藏、重启、退出和重复进塘生命周期修复 · **已实现** |

...
ENSURE_PLAN_ROWS: list[list[object]] = [
    ...
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "480×320 登录入口；登录后显示 1280×720 主窗口、小猫状态栏和底部横向按钮；进入鱼塘调用原生 Overlay 并隐藏主窗口；序列帧状态机与 Overlay 共用 petVisualState",
    ...
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "在 960×480 Overlay 中显示池塘环境、钓位、自己的宠物和钓鱼表现；猫咪基准 128×128；pond_snapshot 驱动，快照更新不重建场景对象",
        "docs/planning/specs/Steam桌面宠物与多人鱼塘表现层.md",
        "2026-08-13",
        "2026-08-15",
    ],
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "在 Overlay 中渲染 pond_user_joined/left/updated；显示同塘玩家宠物、昵称和基础状态",
        "docs/planning/specs/Steam桌面宠物与多人鱼塘表现层.md",
        "2026-08-13",
        "",
    ],
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "在 Overlay/主窗口产品区域提供右键菜单；支持打开主窗口、鱼塘、好友、背包、图鉴、设置、托盘和退出",
        "docs/planning/specs/Steam桌面宠物与多人鱼塘表现层.md",
        "2026-08-13",
        "",
    ],
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "主窗口底部按钮行进入好友/聊天、背包、图鉴、设置弹窗；打开关闭不得触发 leave_pond",
        "docs/planning/specs/Steam桌面宠物与多人鱼塘表现层.md",
        "2026-08-13",
        "",
    ],
    [
        ...
        "v1.0-steam-desktop",
        "P0",
        "验收 480×320 登录、1280×720 主窗口、960×480 Overlay、窗口切换、挂机、通知和断线恢复",
        "docs/planning/specs/Steam桌面宠物与多人鱼塘表现层.md",
        "2026-08-13",
        "",
    ],
    [
        ...
        "v1.0-steam-desktop",
        "P1",
        "独立 WPF/Win32 Overlay；默认 960×480，承载鱼塘和猫咪表现；不启动第二个 Unity Player；通过 Named Pipe 接收状态并发送命令；已修复退出卡死与隐藏窗口 CMD",

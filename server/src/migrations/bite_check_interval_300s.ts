...
const MIGRATION_KEY = 'BITE_CHECK_INTERVAL_300S_V1';

export interface BiteCheckInterval300sMigrationResult {
  updated: boolean;
}

/** v0.3.1：强制 FISH_BITE_CHECK_MS = 300000（5 分钟） */
export function migrateBiteCheckInterval300s(
  database: Database.Database,
): BiteCheckInterval300sMigrationResult {
  const done = database
